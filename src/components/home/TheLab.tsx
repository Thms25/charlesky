    ...
    <section className="min-h-screen flex flex-col justify-center py-20">
      <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                  { title: "Studio Gear", icon: Headphones, desc: "My analog & digital chain", color: "bg-orange-500" },
                  { title: "Tutorials", icon: Youtube, desc: "Production tips & tricks", color: "bg-red-600" },
                  { title: "Playlists", icon: Radio, desc: "What I'm listening to", color: "bg-blue-500" },
              ].map((item, i) => (
                  <motion.div
                      key={i}
