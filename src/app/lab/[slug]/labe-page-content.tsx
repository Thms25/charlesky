...
import { Headphones, Youtube, Radio, LucideIcon, ArrowLeft } from "lucide-react";
...
const labData: Record<string, LabData> = {
  gear: {
    title: "Studio Gear",
...
export default function LabePageContent({ slug }: { slug: string }) {
