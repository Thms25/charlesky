...
function MediaLibraryModal({
  ...
  const [files, setFiles] = useState<
    Array<{ name: string; url: string; ref: StorageReference }>
  >([])
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        ...
        const allFiles = allFilesResults.filter(
          (f): f is { name: string; url: string; ref: StorageReference } =>
            f !== null,
        )
                ...
                <div className="grid gap-4">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setDraft({
                        ...draft,
                        home: { ...draft.home, tagline: e.target.value },
                      })
                    }
                  />
                </div>
                ...
                <div className="border-t border-white/10 pt-6 space-y-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <p className="text-xs text-white/50 truncate">
                          {draft.home.latestRelease.artworkSrc || 'No artwork'}
                        </p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      <p className="text-xs text-white/50 truncate">
                        {draft.bio.headerImage || 'No header image'}
                      </p>
                  ...
                  <button
                    onClick={() => {
                      ...
                      setDraft({
                        ...
                        work: {
                          ...draft.work,
                          projects: [newProject, ...draft.work.projects],
                        },
                      })
                    }}
                ...
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setDraft({
                        ...draft,
                        work: { ...draft.work, headline: e.target.value },
                      })
                    }
                  />
                </div>
                          ...
                          <button
                            onClick={() => {
                              if (
                                ...
                                return
                              const next = draft.work.projects.filter(
                                (_, i) => i !== idx,
                              )
                              setDraft({
                                ...draft,
              ...
              tab !== 'live' && (
                <div className="text-white/70">
                  ...
                  <p className="mt-4 text-white/50 text-sm">
                    The site already reads from Firestore with fallbacks; we can
                    expand these editors as needed.
                  </p>
                </div>
              )}
          </main>
